...
def vbb_anno2dict(vbb_file, cam_id):
    ...
    for frame_id, obj in enumerate(objLists):
        if len(obj) > 0:
            frame_name = 'cal_' + str(cam_id) + "_" + str(filename) + "_I" + str(frame_id+1).zfill(5) + ".jpg"
...
def parse_anno_file(vbb_inputdir, seq_inputdir, vbb_outputdir, seq_outputdir):
    ...
    for sub_dir in sub_dirs:
        ...
        for vbb_file in vbb_files:
            print 'The vbb_file is :',vbb_file
            annos = vbb_anno2dict(vbb_file, cam_id)
            #print 'annos is : ', annos
            #print type(annos)
            print 'The num of image is :' ,len(annos)
            img_size=(640,480)
            if annos:
                print 'the vbb_outputdir is : ', vbb_outputdir           
                vbb_outdir = os.path.join(vbb_outputdir,sub_dir,vbb_file.split('.')[0].split('/')[-1])
                ...
                print 'The vbb_outdir is : ',vbb_outdir
...
def vbb2voc_main(seq_inputdir,vbb_inputdir,seq_outputdir,vbb_outputdir):
   # seq_inputdir = "data/test/seq_file"
   # vbb_inputdir = "data/test/annotations"
   # seq_outputdir = "data/test/img_file"
   # vbb_outputdir = "data/test/xml_file"
    print '~~~~~~~~~~~~~~~~~~~~'
    print 'start vbb2xml'
    print vbb_inputdir
    print seq_inputdir
    ...
    print 'End~~~~~~~~~~~~~~~~~~'
   # xml_file = "data/xml_file/set00/bbox/set00_V013_1512.xml"
   # img_file = "data/img_file/set00/frame/set00_V013_1512.jpg"
